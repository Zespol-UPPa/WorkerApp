...
public class CustomersViewController {
    ...
    public void initialize() {
        ...
        // Dodaj listener do search field
        setupSearchFilter();
    }
    ...
    private void setupTableColumns() {
        ...
        customerColumn.setCellFactory(column -> new TableCell<Customer, String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                    ...
                    nameLabel.setStyle("-fx-font-family: 'Inter 18pt SemiBold'; -fx-font-size: 16px; -fx-text-fill: #333333;");

                    Label emailLabel = new Label(customer.getEmail());
                    emailLabel.setStyle("-fx-font-family: 'Inter 18pt Regular'; -fx-font-size: 14px; -fx-text-fill: #8E8E93;");
        ...
        // VEHICLES Column - Badge z liczbą pojazdów
        vehiclesColumn.setCellValueFactory(cellData -> {
            Customer customer = cellData.getValue();
            return new javafx.beans.property.SimpleStringProperty(
                    customer.getVehiclesCount() > 0 ? customer.getVehicles().get(0).getRegistrationNumber() : ""
            );
        });

        vehiclesColumn.setCellFactory(column -> new TableCell<Customer, String>() {
            @Override
            protected void updateItem(String item, boolean empty) {
                super.updateItem(item, empty);
                ...
                if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                    ...
                    // Badge z pierwszym pojazdem
                    if (customer.getVehiclesCount() > 0) {
                        Label vehicleBadge = new Label(customer.getVehicles().get(0).getRegistrationNumber());
                        vehicleBadge.setStyle(
                        ...
                        // Jeśli jest więcej pojazdów, dodaj "+X" badge
        ...
        // WALLET Column - Saldo portfela z kolorowym oznaczeniem
        ...
        walletColumn.setCellFactory(column -> new TableCell<Customer, String>() {
            @Override
            protected void updateItem(String item, boolean empty) {
                super.updateItem(item, empty);
                ...
                if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                    ...
                    String color = balance < 10 ? "#DC3545" : "#28A745";
        ...
        totalSpentColumn.setCellFactory(column -> new TableCell<Customer, String>() {
            @Override
            protected void updateItem(String item, boolean empty) {
                super.updateItem(item, empty);
        ...
        // ACTION Column - Przezroczysty przycisk ze strzałką
        actionColumn.setCellFactory(column -> new TableCell<Customer, Void>() {
            private final Button arrowButton = new Button();

            {
                // Transparent button with arrow icon
    ...
    private void loadSampleData() {
        // Przykładowi klienci - 20 różnych przypadków
